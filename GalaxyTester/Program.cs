...
namespace GalaxyTester
{
    class Program
    {
		...
		static void SetupSolSystem(StarSystem system)
		{
			...
			world.Name = "Mercury";
			world.ID = 0;
			world.Climate = Planet.Climates.Hot;
			world.TypeClass = Planet.TypeClasses.Selena;
			...
			world.ID = 1;
			world.Climate = Planet.Climates.Hot;
			world.TypeClass = Planet.TypeClasses.Terestrial;
			...
			world.Name = "Terra";
			world.ID = 2;
			world.Climate = Planet.Climates.Temperate;
			world.TypeClass = Planet.TypeClasses.Terestrial;
